...
<div class="block-projects">
  <div> {!! nl2br($project->description) !!}</div class="block-projects">
  </div>
-->
@include('tasks.priority_table')
  <div><a href="/projects/{{$project->id}}">Ver</a> | <a href="/projects/{{$project->id}}/edit">Editar</a></div>
