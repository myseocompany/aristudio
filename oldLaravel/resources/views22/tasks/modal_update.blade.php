            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                    ...
                    <img src="/laravel/storage/app/public/files/{{$item->file_url}}" id="preview_image" style="width: 100%;">
                    @endif
                </div>
                <div class="col-md">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name" required="required" value="{{$item->name}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="priority" name="priority" placeholder="Priority" value="{{$item->priority}}">
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <input type="checkbox" class="form-control col-1" id="not_billing" name="not_billing" value="{{$item->not_billing}}" @if(isset($item->not_billing) && ($item->not_billing==0))  @endif>
                  </div> 
                </div>
                ...
                <div class="col-md">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="points" name="points" placeholder="Points" value="{{$item->points}}" pattern="^(\d(\.\d{1,2})?|0?\.\d{1,2}|2(\.0{1,2})?)$" oninput="validateRange(this)">
                  ...
                  <label for="url_finished">Url Finished Task </label>
                    <input class="form-control" name="url_finished" id="url_finished" placeholder="Url" value="{{$item->url_finished}}">
                  </div>
                </div>
                <div class="form-group col-md-12">
                  <label for="description">Description</label>
                  <textarea class="form-control" name="description" id="description" cols="30" rows="2" value="{{$item->description}}">{{$item->description}}</textarea>
                </div>
                ...
                <div class="form-group col-md-12">
                  ...
                  <!--<a onclick="updateTaskFromModalAJAX({{$item->id}});" href="#">Save Ajax</a> -->
  ...
  <script>
    $(document).ready(function() {
        ...
        function updateModal(element) { // Cambia 'this' por 'element' o cualquier otro nombre
            ...
            // Asumiendo que tienes un campo oculto para el ID, si es necesario descoméntalo
            ...
            $('#editTaskModal #not_billing').prop('checked', taskData.not_billing == 1); // Asegura que la comparación es booleana
