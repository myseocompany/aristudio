...
@if($last_project_id!=$item->project_id)
                ...
                <tr>
                  <th><a href="/projects/{{$item->project_id}}" style="font-size:larger;color:{{$item->project->color}}">{{$item->project->name}}</a></th>
                  <th>&nbsp;</th>
                  <th>Points</th>
                  <th>Person</th>
                  <th>Status</th>
...
<form action="" method="POST" name="updateTaskForm{{$item->id}}" id="updateTaskForm{{$item->id}}">
                  {{ csrf_field() }}
    <tr class="task_row" data-id="{{$item->id}}"  id="task_id_{{$item->id}}">
          ...
          @endif 
            <i class="fas fa-filter hide select-container">
...
<form action="" method="POST" name="updateTaskForm{{$childItem->id}}" id="updateTaskForm{{$childItem->id}}">
    ...
    <tr class="task_row" data-id="{{$childItem->id}}"  id="task_id_{{$childItem->id}}">
      <td class="empty">&nbsp;</td>
                    ...
                    <div id="mini_container no_print" >
                      ...
                      <div class="user_image_mini_container no_print"  >
                        <a hrefd="#" onclick="showTeam({{$childItem->id}})" alt="Asignar responsable" >
                                              ...
                                              <img src="/laravel/storage/app/public/files/users/user.png" alt="" title="" height="26" class="user_image_mini" border="0"> 
  ...
  @endif
                  ...
                  <td id="task_cel_{{$childItem->id}}" style="background-color: @if(isset($childItem->status->background_color)) {{$childItem->status->background_color}}  @endif">
                    <div class="task_container">
                    <div>
