    ...
    <form action="" method="">
	    <div class="row">
	        ...
	        <div class="col">
		        ...
		        <option value="{{$item->id}}"  @if ($item->id == $request->user_id)  selected="selected" @endif >{{$item->name}}</option>
		        @endforeach
	      ...
	      <div class="col">
		        ...
		        <option value="{{$item->id}}"  @if ($item->id == $request->project_id)  selected="selected" @endif >{{$item->name}}</option>
		        @endforeach
