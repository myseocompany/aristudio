          ...
          <div class="col-md">
            ...
            <div class="form-group">
              ...
              <select name="project_id" id="project_id" class="form-control" required="required">
                ...
                <option value="<?php echo e($project->id); ?>" <?php if($project->id == $request->project_id): ?> selected="selected" <?php endif; ?>><?php echo e($project->name); ?></option>
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="due_date" name="due_date" placeholder="YYYY/MMM/DD" required="required"
                valuea="<?php if(!isset($request->from_date)): ?><?php echo e(date('Y-m-d')); ?><?php else: ?><?php echo e($request->from_date); ?><?php endif; ?>"
                value="<?php echo date('Y-m-d'); ?>">
            </div>
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <select name="type_id" id="type_id_<?php echo e($item->id); ?>" class="custom-select" onchange="getSubTypes(this.value );">
                  <option value="">Select a type...</option>
                  <?php $__currentLoopData = $task_types_component; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($option->id); ?>" <?php if($item->type_id==$option->id): ?> selected="selected" <?php endif; ?> ><?php echo e($option->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
          ...
          <div class="col-md">
            <div class="form-group">
              ...
              <select name="user_id" id="user_id" class="form-control">
                ...
                <option value="<?php echo e($user->id); ?>" <?php if($user->id == $request->user_id): ?> selected="selected" <?php endif; ?>><?php echo e($user->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            <div class="form-group">
