...
<?php if(isset($model->project)): ?>
<div>
  <a href="/tasks">Tasks</a> >> 
  <a href="/tasks?project_id=<?php echo e($model->project_id); ?>" style="color: <?php echo e($model->project->color); ?>">
    <?php echo e($model->project->name); ?>
...
<body onload="getMessages(<?php echo e($model->id); ?>,<?php echo e($model->getUser(Auth::user()->id)); ?>); viewUserTask(<?php echo e($model->id); ?>, <?php echo e(Auth::user()->id); ?>)">
<form method="POST" action="/tasks/<?php echo e($model->id); ?>/edit">
  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">

    <?php echo e(csrf_field()); ?>

  <?php if(isset($model->file_url)): ?>

    <img class="task-image" src="<?php echo e('/laravel/storage/app/public/files/'.$model->file_url); ?>" alt="">
    <div>
      <button type="button" class="btn btn-basic"><a href="/tasks/<?php echo e($model->id); ?>/deleteFile">
        Delete File
      </a></button>
    </div>
  <?php endif; ?>
  <div class="form-group">
    ...
    <div class="help-block">
      <a href="<?php echo e('/laravel/storage/app/public/files/'.$model->file_url); ?>">
      <?php echo e($model->file_url); ?>
  ...
  <div class="row">
    ...
    <div class="col">
      <div class="card shadow-sm">
        ...
        <pre  style="background-color: #55595c; padding: 5px; color: white; text-align:center"><?php echo e($model->copy); ?></pre>
      </div>
      <!--
  ...
  <div class="row">
    <div class="col-6">
      ...
      <div class="help-block"><?php if(isset($model->user)): ?><?php echo e($model->user->name); ?> <?php endif; ?></div>
    </div>
    <div class="col-6">
      <label for="name"><strong>Due Date</strong></label>
      <div class="help-block"><?php echo e($model->due_date); ?></div>
    </div>
  ...
  <div class="row">
      ...
      <div class="col-6">
        ...
        <div class="help-block"><?php echo e($model->created_at); ?></div>
      </div>
      <div class="col-6">
        <label for="description"><strong>Project</strong></label>    
        <div class="help-block"><?php echo e($model->project_name); ?></div>
      </div>
      <div class="col-6">
        <label for="description"><strong>Status</strong></label>    
        <div class="help-block"><span class="badge" style="background-color:<?php echo e($model->status->background_color); ?>; color:<?php echo e($model->status->color); ?>"><?php echo e($model->task_status); ?></span></div>
      </div>
      
      <div class="col-6">
        <label for="name" ><strong>Not Billing</strong></label>
        <input type="checkbox" style="pointer-events: none;" class="form-control col-1" id="not_billing" name="not_billing" <?php if($model->not_billing == true): ?> checked <?php endif; ?>>
      </div>
      <div class="col-6">
        <label for="points"><strong>Copy In</strong></label>
        <div class="help-block"><?php echo e($model->copy); ?></div>
      </div>

      <div class="col-6">
        <label for="points"><strong>Copy Out</strong></label>
        <div class="help-block"><?php echo e($model->caption); ?></div>
      </div>

      <div class="col-6">
        <label for="name"><strong>Delivered Date</strong></label>
        <div class="help-block"><?php echo e($model->updated_at); ?></div>
      </div>
      <div class="col-6">
      ...
      <div class="col-6">
        ...
        <div class="help-block"><?php echo e($model->points); ?></div>
      </div>
      <div class="col-6">
        <label for="name"><strong>estimated points</strong></label>    
        <div class="help-block"><?php echo e($model->estimated_points); ?></div>
      </div>
 
      
      <div class="col-6">
        <label for="description"><strong>Priority</strong></label>    
        <div class="help-block"><?php echo e($model->priority); ?></div>
      </div>

      <div class="col-6">
        <label for="points"><strong>Url Finished Task</strong></label>
        <div class="help-block"><a href="<?php echo e($model->url_finished); ?>"><?php echo e($model->url_finished); ?><a></div>
      </div>
 ...
 <div>
   ...
   <input class="form-control" style="width: 45%;" type="text" name="description" id="description_message" class="form-control">
    <input type="hidden" name="" value="" id="task_id">
      ...
      <a class="btn btn-sum btn-primary my-2 my-sm-0" style="margin-top: 5px;color: #ffff !important;" onclick="sendMessage(<?php echo e($model->id); ?>,<?php echo e($model->getUser(Auth::user()->id)); ?> );">Save</a>
      </div>
<div>
...
<h2>Seen by</h2>
  ...
  <?php $__currentLoopData = $task_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="user_image_mini_container no_print">
      <img src="/laravel/storage/app/public/files/users/<?php echo e($task_user->user->image_url); ?>" alt="" class="user_image user_image_mini" title="<?php echo e($task_user->user->name); ?>">
    </div>
    ...
    <div class="table-responsive">
          ...
          <ul class="list-group">
            <?php $now = \Carbon\Carbon::now();?>
             <?php $__currentLoopData = $versions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               
            <li class="list-group-item">Change state to <?php if(isset($item->status_id) && ($item->status_id != '')): ?>
               <strong><?php echo e($item->status->name); ?></strong>, Points <?php echo e($item->points); ?>, due <?php echo e($item->due_date); ?> , updated <?php echo e($item->updated_at); ?>

            <?php endif; ?>
             
            <span class="badge" style="background-color: <?php if(isset($item->status)): ?><?php echo e($item->status->color); ?><?php endif; ?>;">
<?php // $end = \Carbon\Carbon::parse($item->updated_at->format('Y.m.d H:i:s'));
               ...
               // dd($now);
             ?>
            <?php if($years>0): ?><?php echo e($years); ?> years
            <?php else: ?> <?php if($months>0): ?> <?php echo e($months); ?> hours 
            <?php else: ?> <?php if($days>0): ?> <?php echo e($days); ?> days 
            <?php else: ?> <?php if($hours>0): ?> <?php echo e($hours); ?> hours 
            <?php else: ?> <?php if($hours>0): ?> <?php echo e($hours); ?> hours 
            <?php else: ?> <?php if($minutes>0): ?> <?php echo e($minutes); ?> minutes 
            <?php else: ?> <?php if($seconds>0): ?> <?php echo e($seconds); ?> seconds 
             <?php endif; ?> <?php endif; ?> <?php endif; ?> <?php endif; ?> <?php endif; ?> <?php endif; ?> <?php endif; ?>
            </span></li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </ul>
