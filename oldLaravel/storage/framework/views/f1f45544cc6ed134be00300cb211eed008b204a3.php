...
<?php echo e(csrf_field()); ?>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   <label for="type_id">Type</label>
    ...
    <?php $__currentLoopData = $project_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 <div class="form-group">
   <label for="status_id">Status</label>
    ...
    <?php $__currentLoopData = $project_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ?>
    </select>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="color" placeholder="rgb()">   
  </div>
  <div class="form-group">
