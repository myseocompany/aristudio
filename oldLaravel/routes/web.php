...
Route::post('/prospects/{prospects}/update', 'ProspectsController@update');
...
Route::get('/password/edit/{user}', 'UserController@editPassword')->name('password.edit');
Route::post('/password/update/{user}', 'UserController@updatePassword')->name('password.update');
...
Route::post('/tasks/ajax/update', 'TaskController@updateAJAX');
Route::post('/tasks/update', 'TaskController@update');
Route::get('/tasks/setStatus/{task}/{status}','TaskController@setStatus');
...
Route::get('/tasks/update-value-generated/{taskId}/{value_generated}', 'TaskController@updateValueGenerated');
